...
def combine_train_sentences(src_path, tgt_path, src_write_path, tgt_write_path):
...
def combine_dev_sentences(src_path, tgt_path, src_write_path, tgt_write_path, dev_count):
